...
\paragraph{Moderate-to-long separations (35--40 mm):} The cortical fraction rises to $\sim$9--11\%, so $\kappa_{\text{PV}}$ falls to $\sim$9--11 and, crucially, the cortical signal climbs above the noise floor. This is the regime where the correction is reliable (HbO$_2$ RMSE reduced by $\sim$44\% at 38--40~mm; a 30-seed noise sweep is positive in every seed from 35~mm up). The recommended operating range is SDS~$\gtrsim$~35~mm, strongest at 38--40~mm, with the exact onset set by the instrument noise.
