...
At 760~nm: $V_{\mathrm{SSR}}(760) = \frac{1}{1 - 0.206} = \frac{1}{0.794} = 1.26$

At 850~nm: $V_{\mathrm{SSR}}(850) = \frac{1}{1 - 0.903} = \frac{1}{0.097} = 10.31$

Here $R^2_{\mathrm{SS}}(\lambda)$ is the \emph{ordinary} regression $R^2$ of the uncorrected long channel on the short channel (the fraction of long-channel variance removed by SSR), computed identically in the synthetic and real-data pipelines. The two wavelengths differ by nearly an order of magnitude ($1.26$ vs $10.31$), so \emph{no cross-wavelength mean is formed}: their average would not be a physically meaningful quantity. $V_{\mathrm{SSR}}(\lambda)$ is reported per wavelength as a variance-removal diagnostic only.
...
\hline
25 & 0.043 & 23.50 & 1.23 & 11.62 \\
30 & 0.064 & 15.69 & 1.25 & 11.17 \\
35 & 0.086 & 11.57 & 1.28 & 10.34 \\
38 & 0.100 & 10.04 & 1.28 & 9.72 \\
40 & 0.108 & 9.22 & 1.27 & 9.12 \\
\hline
\end{tabular}
\end{center}
